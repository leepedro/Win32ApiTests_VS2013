#if !defined(SIMPLE_2_H)
#define SIMPLE_2_H

// This project demonstrates a simple example of Windows native API.
// This project does exactly what Simple1 does, but the same logic is implemented using a class.
...
{
public:
	wchar_t *ClassName() const { return L"Sample Window Class"; }
